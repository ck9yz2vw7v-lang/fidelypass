...
let OB_STEPS = [
  ...
  {icon:'🔖', title:'Ajoutez cette page à l\\'écran d\\'accueil', text:"Ça permet de retrouver votre carte en un tap, et c'est indispensable sur iPhone pour recevoir vos notifications.", mock:'<div class="ob-phone"><div class="ob-phone-bar">🔒 fidelypass-production.up.railway.app</div><div class="ob-phone-content">🎯</div><div class="ob-phone-toolbar"><span>◀</span><span>▶</span><span class="ob-share-icon">⬆️<span class="ob-callout">👆</span></span><span>📑</span><span>▢▢</span></div><div class="ob-sheet"><div class="ob-sheet-row">📋 Copier</div><div class="ob-sheet-row hl">➕ Sur l\\'écran d\\'accueil</div><div class="ob-sheet-row">🔍 Rechercher sur la page</div></div></div>', iosOnly:true},
