...
document.addEventListener('click', function(e) {
  ...
  else if (act === 'book-slot') bookSlot(arg);
...
function renderBookingSlots() {
  ...
  el.innerHTML = slots.map(iso => {
    ...
    return '<button class="booking-slot-btn" data-act="book-slot" data-arg="' + iso + '">' + t + '</button>';
  }).join('');
}
