...
window.addEventListener('unhandledrejection', function(e) {
  var b = document.createElement('div');
  b.style.cssText = 'position:fixed;top:0;left:0;right:0;background:#dc2626;color:#fff;padding:14px;font-size:12px;z-index:999999;word-break:break-word;font-family:monospace;line-height:1.5';
  b.textContent = '⚠️ PROMESSE REJETEE: ' + (e.reason && e.reason.message ? e.reason.message : e.reason);
  document.body.appendChild(b);
});
const IS_IOS = ${isIOS};

let OB_STEPS = [
  {icon:'📲', title:'Bienvenue ! [TEST-V7]', text:"On vous montre tout ce qu'il faut faire, une bonne fois pour toutes."},
