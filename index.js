...
let OB_STEPS = [
  ...
  {icon:'ℹ️', title:'Au dos de votre carte', text:"Touchez le petit ⓘ en bas de votre carte pour retrouver à tout moment notre numéro de téléphone, le menu et nos horaires.", mock:'<div class="ob-mock"><div class="ob-mock-hand">👆</div><div class="ob-mock-btn light" style="border-radius:50%;width:42px;height:42px;display:flex;align-items:center;justify-content:center;padding:0;font-size:20px">ⓘ</div></div>'},
