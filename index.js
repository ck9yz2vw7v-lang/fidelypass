...
let OB_STEPS = [
  ...
  {icon:'🔖', title:'Ajoutez cette page à l\\'écran d\\'accueil', text:"Ça permet de retrouver votre carte en un tap, et c'est indispensable sur iPhone pour recevoir vos notifications.", mock:'<div class="ob-phone"><div class="ob-phone-status"><span>9:41</span><span>🔋</span></div><div class="ob-phone-bar">🔒 fidelypass-production.up.rail...</div><div class="ob-phone-content">🎯</div><div class="ob-phone-toolbar"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#9ca3af" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"/></svg><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#d1d5db" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6l6 6-6 6"/></svg><span class="ob-share-icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#3b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12"/><path d="M7 8l5-5 5 5"/><path d="M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/></svg><span class="ob-callout">👆</span></span><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#9ca3af" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19V5a2 2 0 012-2h8l6 6v10a2 2 0 01-2 2H6a2 2 0 01-2-2z"/><path d="M14 3v6h6"/></svg><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#9ca3af" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="14" height="14" rx="2"/><path d="M7 21h10a2 2 0 002-2V7"/></svg></div><div class="ob-sheet"><div class="ob-sheet-handle"></div><div class="ob-sheet-row"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="8" y="8" width="12" height="12" rx="2"/><path d="M4 16V4a2 2 0 012-2h10"/></svg> Copier</div><div class="ob-sheet-row hl"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#1d4ed8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="5"/><path d="M12 8v8M8 12h8"/></svg> Sur l\\'écran d\\'accueil</div><div class="ob-sheet-row"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.35-4.35"/></svg> Rechercher</div></div></div>', iosOnly:true},
