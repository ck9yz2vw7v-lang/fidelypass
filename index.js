...
let OB_STEPS = [
  ...
  {icon:'🔖', title:'Ajoutez cette page à l\\'écran d\\'accueil', text:"Ça permet de retrouver votre carte en un tap, et c'est indispensable sur iPhone pour recevoir vos notifications.", mock:'<div class="ob-mock"><div class="ob-mock-step">1. Touchez <strong>Partager</strong> tout en bas de l\\'écran</div><div class="ob-mock-hand">👆</div><div class="ob-safari-bar"><span>◀</span><span>▶</span><span class="hl">⬆️</span><span>📑</span><span>▢▢</span></div><div class="ob-mock-step" style="margin-top:14px">2. Faites défiler, puis touchez <strong>« Sur l\\'écran d\\'accueil »</strong></div></div>', iosOnly:true},
